                ...
                <textarea class="form-control" type="text" id="description"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span style="opacity: 0.7">{{ old('image_bw',isset($pdf) &&  $pdf->image_bw ? basename($pdf->image_bw) : null) }}</span>
                            </div>
                            @error('image_bw')
                            <div class="col-sm-12">
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span style="opacity: 0.7">{{ old('files_bw',isset($pdf) &&  $pdf->files_bw ? basename($pdf->files_bw) : null) }}</span>
                            </div>
                            @error('files_bw')
                            <div class="col-sm-12">
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span style="opacity: 0.7">{{ old('image_color',isset($pdf) &&  $pdf->image_color ? basename($pdf->image_color) : null) }}</span>
                            </div>
                            @error('image_color')
                            <div class="col-sm-12">
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span style="opacity: 0.7">{{ old('files_color',isset($pdf) &&  $pdf->files_color ? basename($pdf->files_color) : null) }}</span>
                            </div>
                            @error('files_color')
                            <div class="col-sm-12">
                                <span class="text-danger">{{ $message }}</span>

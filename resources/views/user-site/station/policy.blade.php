        ...
        <div class="container">
            <div class="content-holder">
                <div class="content-box">
                    <div class="box-body">
                        <h4 class="mto mbo"><strong class="large">You can shop with confidence at MommyMeStation.com.</strong></h4>
                        ...
                        <p>Please note that only items that have been purchased directly from MommyMeStation.com can be refunded. MommyMeStation.com products purchased through other retailers must be returned in accordance with their respective returns and refunds policy.</p>
                        ...
                        <p>Customers requesting repeated returns may be blocked from making further purchases using MommyMeStation.com services. Customers that violate the terms of use of a product may have their right of return revoked for such product.</p>
                        <p>For additional information, please read MommyMeStation.com <a href="{{ route('terms') }}">Terms and Conditions</a>.</p>
                    </div>
                </div>
            </div>
        </div>

        ...
        <div class="container"><div class="content-holder">
                ...
                <div class="auth-container">
                    <div style="margin: 0 20px">
                        <h1 class="hpage2 signup" style="font-size: 30px;">@lang('app.join_free')
                    </div>
...
{{--                        </div>--}}
                        <form id="NewUserForm" action="/user/register" onsubmit="return frmValidCheck(this);" method="post">
                            ...
                            <label id="form_label_person_name" class="XMLabel" for="person_name" style=""><span class="astrix">*</span>@lang('app.first_name')</label>
                            ...
                            <label id="form_label_person_name" class="XMLabel" for="person_name" style=""><span class="astrix">*</span>@lang('app.last_name')</label>
                            ...
                            <label id="form_label_person_name" class="XMLabel" for="person_name" style=""><span class="astrix">*</span>@lang('app.public_name')</label>
                            ...
                            <label id="form_label_email" class="XMLabel" for="email" style=""><span class="astrix">*</span>E-mail</label>
                            ...
                            <label id="form_label_password" class="XMLabel" for="password" style=""><span class="astrix">*</span>@lang('app.password')</label>
                            ...
                            <label id="form_label_position" class="XMLabel" for="position" style=""><span class="astrix">*</span>@lang('app.role')</label>
                        ...
                        <div class="fld-options center"><small>Creating an account means you agree to Mommy Me Station's <a href="/terms-and-conditions" target="_blank">Terms and Conditions</a> and <a href="/privacy-statement" target="_blank">Privacy Statement</a></small>.</div>
                        <div class="auth-foot center">
                            <strong>@lang('app.have_acc') </strong> <a href="/user/login">@lang('app.login')</a>.
                        </div>
                    </div>
                    <div>&nbsp;</div>
                </div>

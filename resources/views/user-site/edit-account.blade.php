                                                ...
                                                <colgroup><col style="width:auto;text-overflow:ellipsis;">
                                                    ...
                                                    <td valign="top" class="padleft">
                                                        ...
                                                        <div style="word-wrap:break-word;;">
                                                            ...
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Subject" vrequired="false" type="checkbox" name="subject_prefer[]" id="subject_2" value="Art &amp; Coloring" class="clRadioCheck" @if(in_array('Art & Coloring', $data->subject_prefer)) checked @endif><label>@lang('app.Art & Coloring')</label></div>

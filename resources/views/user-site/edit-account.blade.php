                                        ...
                                        <td class="XMFormRow XMFormRowChild" valign="top" colspan="1" style="width:50.00%;">
                                            <table width="100%" border="0" class="rwd" cellpadding="2" cellspacing="0" style="table-layout:fixed">
                                                <colgroup><col style="width:160px;">
                                                    ...
                                                    <td valign="top" class="padleft"><label id="form_label_email" class="XMLabel" for="email" style=""><span class="astrix">*</span>E-mail Address</label></td>
                                                    <td valign="top" style="word-wrap:break-word;;"><input id="email" mask="" maxlength="50" vtype="email" hint="" placeholder="name@domain.com" vlabel="E-mail Address" vrequired="true" class="clInput form-control xm-input-email" data-inputtype="email" style="" type="email" name="email" value="{{ old('email', $data->email ?? '') }}" disabled>
                                                    </td>
                                                </tr>
                                                </tbody></table>
                                        </td>
                                        <td class="XMFormRow XMFormRowChild" valign="top" colspan="1" style="width:50.00%;">
                                            <table width="100%" border="0" class="rwd" cellpadding="2" cellspacing="0" style="table-layout:fixed">
                                                <colgroup><col style="width:160px;">
                                                    ...
                                                    <td valign="top" class="nonmandatory padleft"><label id="form_label_nickname" class="XMLabel" for="nickname" style="">Public Name <div data-tooltip="Your public name will appear on product reviews." class="xmTip" style="display:inline-block;"><span class="icon-question"></span></div></label></td>
                                        ...
                                        <td class="XMFormRow XMFormRowChild" valign="top" colspan="1" style="width:50.00%;">
                                            <table width="100%" border="0" class="rwd" cellpadding="2" cellspacing="0" style="table-layout:fixed">
                                                <colgroup><col style="width:160px;">
                                                    ...
                                                    <td valign="top" class="nonmandatory padleft"><label id="form_label_country" class="XMLabel" for="country" style="">Location</label></td>
                                            ...
                                            <table width="100%" border="0" class="rwd" cellpadding="2" cellspacing="0" style="table-layout:fixed">
                                                <colgroup><col style="width:auto;text-overflow:ellipsis;">
                                                    ...
                                                    <td valign="top" class="padleft">
                                                        <label id="form_label_position" class="XMLabel" for="position" style="">I'm a</label>
                                                        <div style="word-wrap:break-word;;">
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Your%20Position" vrequired="false" type="checkbox" name="role[]" id="position_1" value="Teacher" class="clRadioCheck" @if(in_array('Teacher', $data->role)) checked @endif><label>Teacher</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Your%20Position" vrequired="false" type="checkbox" name="role[]" id="position_2" value="Homeschooler" class="clRadioCheck" @if(in_array('Homeschooler', $data->role)) checked @endif><label>Homeschooler</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Your%20Position" vrequired="false" type="checkbox" name="role[]" id="position_3" value="Parent" class="clRadioCheck" @if(in_array('Parent', $data->role)) checked @endif><label>Parent</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Your%20Position" vrequired="false" type="checkbox" name="role[]" id="position_4" value="School Administrator" class="clRadioCheck" @if(in_array('School Administrator', $data->role)) checked @endif><label>School Administrator</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Your%20Position" vrequired="false" type="checkbox" name="role[]" id="position_5" value="Tutor" class="clRadioCheck" @if(in_array('Tutor', $data->role)) checked @endif><label>Tutor</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Your%20Position" vrequired="false" type="checkbox" name="role[]" id="position_6" value="Child Care" class="clRadioCheck" @if(in_array('Child Care', $data->role)) checked @endif><label>Child Care</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Your%20Position" vrequired="false" type="checkbox" name="role[]" id="position_7" value="Other" class="clRadioCheck" @if(in_array('Other', $data->role)) checked @endif><label>Other</label></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tbody></table>
                                        ...
                                        <td class="XMFormRow XMFormRowChild" valign="top" colspan="2" style="width:100%;">
                                            <table width="100%" border="0" class="rwd" cellpadding="2" cellspacing="0" style="table-layout:fixed">
                                                <colgroup><col style="width:auto;text-overflow:ellipsis;">
                                                    ...
                                                    <td valign="top" class="padleft">
                                                        <label id="form_label_subject" class="XMLabel" for="subject" style="">I'm interested in</label>
                                                        <div style="word-wrap:break-word;;">
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Subject" vrequired="false" type="checkbox" name="subject_prefer[]" id="subject_1" value="Maths" class="clRadioCheck" @if(in_array('Maths', $data->subject_prefer)) checked @endif><label>Maths</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Subject" vrequired="false" type="checkbox" name="subject_prefer[]" id="subject_2" value="Arts &amp; Colors" class="clRadioCheck" @if(in_array('Arts & Colors', $data->subject_prefer)) checked @endif><label>ARTS & COLORING</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Subject" vrequired="false" type="checkbox" name="subject_prefer[]" id="subject_3" value="Writing" class="clRadioCheck" @if(in_array('Writing', $data->subject_prefer)) checked @endif><label>Writing</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Subject" vrequired="false" type="checkbox" name="subject_prefer[]" id="subject_4" value="Story" class="clRadioCheck" @if(in_array('Story', $data->subject_prefer)) checked @endif><label>Story</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Subject" vrequired="false" type="checkbox" name="subject_prefer[]" id="subject_4" value="Logic" class="clRadioCheck" @if(in_array('Logic', $data->subject_prefer)) checked @endif><label>Logic</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Subject" vrequired="false" type="checkbox" name="subject_prefer[]" id="subject_5" value="Blog" class="clRadioCheck" @if(in_array('Blog', $data->subject_prefer)) checked @endif><label>Blog</label></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tbody></table>
                                        ...
                                        <td class="XMFormRow XMFormRowChild" valign="top" colspan="1" style="width:50.00%;">
                                            <table width="100%" border="0" class="rwd" cellpadding="2" cellspacing="0" style="table-layout:fixed">
                                                <colgroup><col style="width:auto;text-overflow:ellipsis;">
                                                    ...
                                                    <td valign="top" class="padleft">
                                                        <label id="form_label_grade" class="XMLabel" for="grade" style="">I teach</label>
                                                        <div style="word-wrap:break-word;;">
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Grade" vrequired="false" type="checkbox" name="grade_teacher[]" id="grade_1" value="Preschool" class="clRadioCheck" @if(in_array('Preschool', $data->grade_teacher)) checked @endif><label>Preschool</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Grade" vrequired="false" type="checkbox" name="grade_teacher[]" id="grade_2" value="Kindergarten" class="clRadioCheck" @if(in_array('Kindergarten', $data->grade_teacher)) checked @endif><label>Kindergarten</label></div>
                                                            <div class="fld-options"><input vtype="checkbox" vlabel="Grade" vrequired="false" type="checkbox" name="grade_teacher[]" id="grade_3" value="1st Grade and Above" class="clRadioCheck" @if(in_array('1st Grade and Above', $data->grade_teacher)) checked @endif><label>1st Grade and Above</label></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tbody></table>
                                        ...
                                        <td class="XMFormRow XMFormRowChild" valign="top" colspan="1" style="width:50.00%;">
                                            <table width="100%" border="0" class="rwd" cellpadding="2" cellspacing="0" style="table-layout:fixed">
                                                <colgroup><col style="width:auto;text-overflow:ellipsis;">
                                                    ...
                                                    <td valign="top" class="padleft">
                                                        <label id="form_label_color_preference" class="XMLabel" for="color_preference" style="">Worksheet color preference</label>
                                        ...
                                        <td class="XMFormRow XMFormRowChild" valign="top" colspan="1" style="width:50.00%;">
                                            <table width="100%" border="0" class="rwd" cellpadding="2" cellspacing="0" style="table-layout:fixed">
                                                <colgroup><col style="width:auto;text-overflow:ellipsis;">
                                                    ...
                                                    <td valign="top" class="padleft">
                                                        <label id="form_label_gender" class="XMLabel" for="gender" style="">Worksheet gender preference</label>
                                                        <div style="word-wrap:break-word;;">
